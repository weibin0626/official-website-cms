...
const menuItems: MenuItem[] = [
  ...
  { text: '轮播图', icon: <ViewCarouselIcon />, path: '/admin/banners', permission: 'banner:read' },
  { text: '友链管理', icon: <LinkIcon />, path: '/admin/friendlinks', permission: 'friendlink:read' },
  { text: '领导介绍', icon: <PersonIcon />, path: '/admin/leaders', permission: 'leader:read' },
  { text: '师资队伍', icon: <SchoolIcon />, path: '/admin/teachers', permission: 'teacher:read' },
